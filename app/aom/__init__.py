...
``targets/story-text/``, ``targets/audio/``, ``targets/story-images/``,
``media/``) and is the single source of truth. Nothing here writes to the story;
it only reads and presents it.
"""
